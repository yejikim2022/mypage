import {animal_questions} from './question_data.js'
...
function renderQuestion(){ //질문을 하나씩 출력
    const question = animal_questions[currentNumber]//답을 선택하면 다음 질문으로 넘어감
...
function nextQuestion(optionNumber){ //다음 질문으로 이동
    ...
    const question = animal_questions[currentNumber] //option을 클릭 시 실행
